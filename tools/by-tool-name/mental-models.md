...
Before formal modeling or taking action, mentally simulate the system: if this were running, what would happen? Trace through time, following causal chains and feedback loops. Mental simulation surfaces structural errors, missing variables, and implausible assumptions cheaply.
...
Use mental simulation when:
- Before building formal models (cheaper to catch errors early)
- Planning complex operations with many moving parts
- Evaluating proposed interventions or strategies
- Someone's explanation sounds plausible but you want to test internal consistency
- Debugging by tracing through execution paths

Mental simulation is faster than formal modeling but catches many of the same errors. It's a sanity check, not a replacement for rigorous analysis.
