...
The true cost of any choice is the value of the best alternative you gave up - not what you paid, but what you forwent. Every resource used for one purpose becomes unavailable for its next-best use.
...
Use opportunity cost reasoning when:
- Making allocation decisions with scarce resources (time, money, attention, personnel)
- Evaluating sunk costs (which are NOT opportunity costs - they're irrelevant to forward-looking decisions)
- Comparing options where sticker price misleads (free time isn't actually free)
- Someone says "we can't afford not to do X" (forces explicit comparison to alternatives)
- Evaluating career, education, or major life decisions

The tool corrects our tendency to compare choices to "doing nothing" rather than to realistic alternatives.
